...
export async function ensureBigBangTables() {
  ...
  try {
    ...
    const alters = [
      sql`ALTER TABLE bb_redes ADD COLUMN IF NOT EXISTS revisado BOOLEAN NOT NULL DEFAULT FALSE`,
      sql`ALTER TABLE bb_redes ADD COLUMN IF NOT EXISTS feedback TEXT NOT NULL DEFAULT ''`,
      sql`ALTER TABLE bb_redes ADD COLUMN IF NOT EXISTS tipo_grabacion TEXT NOT NULL DEFAULT ''`,
      sql`ALTER TABLE bb_redes ADD COLUMN IF NOT EXISTS guion TEXT NOT NULL DEFAULT ''`,
      sql`ALTER TABLE bb_redes ADD COLUMN IF NOT EXISTS imagen TEXT NOT NULL DEFAULT ''`,
      sql`ALTER TABLE bb_redes ADD COLUMN IF NOT EXISTS video_url TEXT NOT NULL DEFAULT ''`,
    ];
