          ...
          <div className="flex flex-col gap-3">
            <div>
              ...
              <input value={nombre} onChange={e => setNombre(e.target.value)}
                ...
                style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="Nombre del servicio" />
            </div>
            <div>
              ...
              <textarea value={desc} onChange={e => setDesc(e.target.value)} rows={3}
                ...
                style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="Descripción del servicio para el catálogo..." />
            </div>
            <div>
              ...
              <textarea value={incluyeRaw} onChange={e => setIncluyeRaw(e.target.value)} rows={5}
                className="w-full px-3 py-2 rounded-xl border font-dm text-sm bg-white outline-none resize-none"
                style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="Mesas decorativas&#10;Alfombra&#10;Arco de globos..." />
            </div>
            <div>
              ...
              <textarea value={condiciones} onChange={e => setCondiciones(e.target.value)} rows={4}
                className="w-full px-3 py-2 rounded-xl border font-dm text-sm bg-white outline-none resize-none"
                style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="Seña, zona de trabajo, política de alquiler..." />
            </div>
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input type="number" value={precioMin} onChange={e => setPrecioMin(e.target.value)}
                  className="w-full px-3 py-2 rounded-xl border font-dm text-sm bg-white outline-none"
                  style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="100000" />
              </div>
              <div>
                ...
                <input type="number" value={precioMax} onChange={e => setPrecioMax(e.target.value)}
                  className="w-full px-3 py-2 rounded-xl border font-dm text-sm bg-white outline-none"
                  style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="300000" />
              </div>
              <div>
                ...
                <input value={tiempo} onChange={e => setTiempo(e.target.value)}
                  className="w-full px-3 py-2 rounded-xl border font-dm text-sm bg-white outline-none"
                  style={{ borderColor: '#fbcfe8', color: '#1f2937', WebkitTextFillColor: '#1f2937' }} placeholder="2–3 horas" />
              </div>
            </div>
